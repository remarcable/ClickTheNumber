...
$(function () {
  ...
  $('main').on('click', function (e) {
    ...
    if (clickVal === 26) {
      clickVal++;
      var DOMString = '<div class="done">Geschafft! Zeit: ' + Timer.EndTiming() + 's</div><button type="button" name="button" class="btn new" onClick="window.location.reload();">Neu</button>';
